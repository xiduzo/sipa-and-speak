...
**DDD rules for user stories** (see `@.wtf/workflow/skills/references/ddd-writing-rules.md`):
...
Scan the capability name, user stories, and clarified context against the anti-patterns defined in `@.wtf/workflow/skills/references/ddd-writing-rules.md`. Flag and correct any violations found.
...
**DDD writing rules for this draft** (see `@.wtf/workflow/skills/references/ddd-writing-rules.md` for full rules):
